...
export const BORDER_LIGHT = {
  color: {
    strong: GRAY_SCALE_LIGHT.gray5,
    medium: GRAY_SCALE_LIGHT.gray4,
    light: GRAY_SCALE_LIGHT.gray3,
    secondaryInverted: GRAY_SCALE_LIGHT.gray9,
    inverted: GRAY_SCALE_LIGHT.gray11,
